...
class DatabaseTestSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $merchant1 = Merchant::factory()->create([
            'name' => 'Merchant 1',
            'currency_uuid' => $cop->uuid,
        ]);
        $merchant2 = Merchant::factory()->create([
            'name' => 'Merchant 2',
            'currency_uuid' => $usd->uuid,
        ]);
        Transaction::factory(10)->create([
            'created_at' => '2021-01-01',
            'purchase_amount' => 15000,
            'currency_uuid' => $usd->uuid,
            'payment_method_uuid' => $visa->uuid,
            'merchant_uuid' => $merchant1->uuid,
        ]);
        Transaction::factory(10)->create([
            'created_at' => '2021-01-10',
            'purchase_amount' => rand(10000, 20000),
            'currency_uuid' => $usd->uuid,
            'payment_method_uuid' => $masterCard->uuid,
            'merchant_uuid' => $merchant1->uuid,
        ]);
        Transaction::factory(10)->create([
            'created_at' => '2021-01-10',
